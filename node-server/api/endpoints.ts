...
import { AdminRequest, animalSchema, fileUploadBodySchema, loginRequestBodySchema, trainingLogSchema, UserPayload, userSchema } from '../types';
...
app.use((req, res, next) => {
    try {
        ...
        const decoded = jwt.verify(authToken, process.env.SECRET_KEY!) as UserPayload;
